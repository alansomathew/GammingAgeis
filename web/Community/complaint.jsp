<%-- 
    Document   : complaint
    Created on : 4 Jan, 2021, 12:38:34 PM
    Author     : alans
--%>
...
<html>
    ...
    <body>
        ...
        { 
            ...
            ins="insert into tbl_complaint(complaint_description,complaint_date,community_id) values('"+feed+"',curdate(),'"+udi+"')";
            //out.print(ins);
            ...
            <table border="2">
              <tr>COMPLAINT LIST</tr>            
                <tr>
                   ...
                   <%
        int i=0;
        String sela="select * from tbl_complaint where community_id='"+udi+"'";
       //out.println(sela);
        ...
        %>
                   <tr>
                    ...
                    <td><%=rsa.getString("complaint_replay")%></td>
                   </tr> 
                    <%
