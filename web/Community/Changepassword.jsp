<%-- 
    ...
    Created on : 15 Dec, 2020, 2:13:08 PM
    Author     : alans
--%>
...
<!--        <title>Change Password</title>
    ...
    <body>
        ...
        <%
          ...
          if(cid !=null)
        {
            String selc="select * from tbl_community where community_id='"+ cid+"'";
            ResultSet rs1=con.select(selc);
            if(rs1.next())
            {
                pass=rs1.getString("community_password");
            }
         if(request.getParameter("btnsave")!=null)
        {
             ...
             if(o.equals(pass))
             {
                ...
                String c=request.getParameter("conpass");
                 if(n.equals(c))
                 {
                      String upd="update tbl_community set community_password='"+request.getParameter("newpass")+"' where community_id='"+ cid+"'";
