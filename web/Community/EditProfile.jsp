<%-- 
    ...
    Created on : 15 Dec, 2020, 12:58:34 PM
    Author     : alanso
--%>
...
<!--        <title>Edit profile</title>
    ...
    <body>
         <div id="tab">
    <%
         String editid=session.getAttribute("cid").toString();
        String nme="",num="",mail="",gid="",gtype="",pti="";
         String selc="select * from tbl_community where community_id='"+ editid+"'";
            ResultSet rs1=con.select(selc);
            if(rs1.next())
            {
                nme=rs1.getString("community_name");
                num= rs1.getString("community_contact");
                mail= rs1.getString("community_email");}
        if(request.getParameter("btnsave")!=null)
        {
         String upd="update tbl_community set community_name='"+request.getParameter("txtname")+"',community_contact='"+request.getParameter("txtphno")+"',community_email='"+request.getParameter("txtmail")+"' where community_id='"+editid+"'";
        out.println(upd);
...
<!--                    <td><input type="text" name="txtname" value=""required="required" autocomplete="off"></td>
                ...
                <tr>
                    <td>Email-ID:</td>
                    <td><input type="email" name="txtmail" value="" required="required" autocomplete="off" ></td>-->
		...
		<div class="wrapper" style="background-image: url('images/bg-registration-form-1.jpg');">
			<div class="inner">
				<div class="image-holder">
                                    <img src="../temp/colorlib-regform-17/colorlib-regform-17/images/registration-form-1 (2).jpg" alt="">
				</div>
				<form action="">
					<h3>Update Here</h3>
					...
					<div class="form-wrapper">
						<input type="text" placeholder="Address" class="form-control" name="txtaddress"  value="" required="required" autocomplete="off">
            ...
            <div class="card card-3">
                ...
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3 card-3" type="text" placeholder="Contact" name="txtphno"  value="<%=num%>" required="required" autocomplete="off" pattern="[0-9+]{10,13}">
                            <i class="cont"></i>
                        </div>
<!--                            <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Address" name="txtaddress"  value="" required="required" autocomplete="off">
