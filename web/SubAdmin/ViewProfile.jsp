<%-- 
    ...
    Created on : 15 Dec, 2020, 3:15:54 PM
    Author     : alanso
--%>
...
<% 
            ...
            %>
             <%
                     String sel="select * from tbl_subadmin where subadmin_id='"+udi+"'";
                     //out.println(sel);
			...
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form">
					...
					<span class="login100-form-title p-t-20 p-b-45">
						<%= rs.getString("subadmin_name") %>
					</span>

					<div class="wrap-input100 validate-input m-b-10" data-validate = "Username is required">
						<input class="input100" type="text" name="username" value="<%= rs.getString("subadmin_address") %>" placeholder="Username">
					...
					<div class="wrap-input100 validate-input m-b-10" data-validate = "Password is required">
                                            <input class="input100" type="text" value="<%= rs.getString("subadmin_contact") %>" name="pass" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-phone"></i>
                                                ...
                                                <div class="wrap-input100 validate-input m-b-10" data-validate = "Password is required">
                                            <input class="input100" type="text" value="<%= rs.getString("subadmin_email") %>" name="pass" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
