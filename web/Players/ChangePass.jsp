<%-- 
    ...
    Created on : 5 Dec, 2020, 2:09:35 PM
    Author     : alanso
--%>
...
<html>
    ...
    <body>
        ...
        <%
          ...
          if(cid !=null)
        {
            String selc="select * from tbl_players where player_id='"+ cid+"'";
            ResultSet rs1=con.select(selc);
            if(rs1.next())
            {
                pass=rs1.getString("player_password");
            }
         if(request.getParameter("btnsave")!=null)
        {
             ...
             if(o.equals(pass))
             {
                ...
                String c=request.getParameter("conpass");
                 if(n.equals(c))
                 {
                      String upd="update tbl_players set player_password='"+request.getParameter("newpass")+"' where player_id='"+ cid+"'";
...
<!--                            <div class="form-group">
                        ...
                        <a href="index.jsp" class="signup-image-link">Don't Change</a>
                    </div>
                        </form>
                        </div>
                    </div>
